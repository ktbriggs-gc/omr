...
protected:
	...
	uintptr_t _evacuatorTraceOptions;
...
public:
	...
	static const uintptr_t min_workspace_size = 1024;
...
#if defined(EVACUATOR_DEBUG) || defined(EVACUATOR_DEBUG_ALWAYS)
	static bool isEvacuatorScanning(MM_GCExtensionsBase *extensions, uintptr_t scanOptions) { return (0 != (extensions->evacuatorScanOptions & scanOptions)); }
	static bool isEvacuatorTracing(MM_GCExtensionsBase *extensions, uintptr_t traceOptions) { return (0 != (extensions->evacuatorTraceOptions & traceOptions)); }
	bool isDebugFlagSet(uintptr_t traceOption) { return (traceOption == (traceOption & _evacuatorTraceOptions)); }
	bool isAnyDebugFlagSet(uintptr_t traceOptions) { return (0 != (traceOptions | _evacuatorTraceOptions)); }
	bool areAllDebugFlagsSet(uintptr_t traceOptions) { return isDebugFlagSet(traceOptions); }
...
#else
	bool isDebugFlagSet(uintptr_t traceOption) { return false; }
	bool isAnyDebugFlagSet(uintptr_t traceOptions) { return false; }
	bool areAllDebugFlagsSet(uintptr_t traceOptions) { return false; }
